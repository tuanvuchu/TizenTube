  ...
  const settings = [
    {
      ...
      options: {
        ...
        content: scrollPaneRenderer([
          overlayMessageRenderer(
            "If you enjoy using TizenTube and would like to support its development, consider the following:",
          ),
          overlayMessageRenderer(
        ...
        return {
          ...
          options: {
            ...
            content: overlayPanelItemListRenderer([
              overlayMessageRenderer(
                `You can visit the ${option.name} page by scanning the QR code below.`,
              ),
      ...
      options: [
        ...
        },
        {
          ...
          menuHeader: {
            ...
            subtitle:
              "Choose the preferred or next best video quality applied when playback starts",
          },
          options: [
            "Auto",
            "2160p",
        ...
        },
        {
          ...
          menuHeader: {
            ...
            subtitle:
              "Set the speed increments for video playback speed adjustments",
          },
        ...
        window.h5vcc.tizentube.SetFrameRate
          ? {
              ...
              menuHeader: {
                ...
                subtitle:
                  "Set the duration (in seconds) to pause video playback when adjusting frame rate",
              },
          ...
          options: [
            ...
            },
            {
              ...
              menuHeader: {
                ...
                subtitle:
                  "Set the percentage threshold for hiding watched videos",
              },
          ...
          options: [
            ...
            },
            {
              ...
              menuHeader: {
                ...
                subtitle:
                  "Set the inactivity timeout (in seconds) before the screen dims",
              },
